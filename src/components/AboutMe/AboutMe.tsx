    ...
    return (
        <div className="flex flex-col justify-center items-center w-full ">
            <div className='w-100 h-100 flex flex-1 flex-col justify-center items-center'>
                <h1 className="text-4xl font-bold text-white mt-5 mb-5">About Me</h1>
                <Image width={150} height={150} src={Profile} alt="Profile" className='flex-col justify-center items-center' />
