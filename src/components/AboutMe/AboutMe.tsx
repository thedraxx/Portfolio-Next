            ...
            >
                ...
                <div className="flex flex-col mt-5  sm: w-56 lg:w-96  " >
                    ...
                    >
                        <a
                            target="_blank"
                            href='https://www.canva.com/design/DAFbctdw6bc/swJyLv5qczjY97G5fB2nDQ/edit?utm_content=DAFbctdw6bc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' rel="noreferrer">Check Resume</a>
                    </div>
                </div>
